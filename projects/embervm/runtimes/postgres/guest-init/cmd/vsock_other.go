...
// listenVsock always fails off Linux: AF_VSOCK is Linux-only. The postgres guest
...
func listenVsock(_ uint32) (net.Listener, error) {
	return nil, fmt.Errorf("ember-postgres-init: AF_VSOCK unsupported on %s", runtime.GOOS)
}

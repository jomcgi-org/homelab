...
| [ARCHITECTURE.md, section 13](ARCHITECTURE.md#13-decision-history) | Why: each decision's status and where its rationale now lives (the `**Why.**` paragraph per section) |

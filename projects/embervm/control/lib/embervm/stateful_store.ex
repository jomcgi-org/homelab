defmodule Embervm.StatefulStore do
  ...
  and limbo states. This byte-identical property has a 90-second grace bound.
  A node that never reports cannot retain an endpoint merely because its last
  durable state was :serving.

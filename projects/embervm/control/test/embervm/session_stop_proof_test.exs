defmodule Embervm.SessionStopProofTest do
  ...
  test "native proof must match every immutable identity and follow the intent" do
    ...
    assert {:error, _} = Proof.validate(intent, put_in(response, [:completion, :completed_at_unix_ms], 99))
  end

"""SQLModel definition for the ember demo savings table.

DemoPgSavings mirrors chart/migrations/20260718000000_demo_pg_savings.sql.
It is a single-row table: id is fixed to 1, so there is exactly one all-time
counter shared by every visitor of the exhibit.
"""

...
the default app.db engine (which is public_reader on the read replica and
cannot write). PUBLIC_WRITER_DATABASE_URL is set only on the public profile;
the private tier falls back to app.db.get_engine(), unchanged from before
this module existed.
"""
...
from app.db import get_engine as get_default_engine

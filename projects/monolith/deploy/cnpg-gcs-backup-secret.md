# Monolith CNPG GCS backup credential

This note records the existing out-of-band credential used by CloudNativePG:

- 1Password item path: `vaults/k8s-homelab/items/cnpg-gcs-backups-monolith`
- Field name: `service-account-key.json`
- Service account: `cnpg-backup-monolith@h0melab.iam.gserviceaccount.com`

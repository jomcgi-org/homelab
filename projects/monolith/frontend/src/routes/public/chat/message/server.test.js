...
describe("/public/chat/message POST", () => {
  it("reads the session id from the cps cookie, never the body, and drops injected history", async () => {
    ...
    expect(url).toMatch(/\/internal\/chat\/message$/);

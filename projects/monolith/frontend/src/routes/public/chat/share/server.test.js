...
describe("/public/chat/share POST", () => {
  it("reads the session id from the cps cookie, never the body, and forwards no transcript", async () => {
    ...
    expect(calledUrl).toMatch(/\/internal\/chat\/share$/);

export const RUN_LEXICON = {
  ...
  labels: {
    ...
    escalatedToYou: "Escalated to you",
    ...
    escalationTerminal:
      "This run escalated to you. Continue in the session; the run itself cannot resume yet.",
    ...
    once: "once",
    times: "times",
    deliveryRetriedOnce: "delivery retried once",

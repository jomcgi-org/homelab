...
// public reader. Ported verbatim from the private lib/grimoire/renderChunk.js
// (same Marker/LLM extraction shape, same structural rules): the public tier
// reads the identical `knowledge_chunk.content` text, so the parser has no
// campaign/viewpoint dependency and copies over unchanged.
//
// Marker/LLM extraction emits single-newline-separated lines: bullet lines,
// short ALL-CAPS section headings, and prose. Splitting naively on blank lines
// merges single-newline bullets into run-on paragraphs and renders inline
// headings as body text (e.g. the D&D Monster Manual "DUNGEONS" / "THE
// UNDERDARK" chunk). This groups lines into typed blocks the reader renders
// without {@html}.
//

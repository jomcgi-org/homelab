...
def adopt_response_lost_result(
    ...
    """
    from factory.execution import result_receipts, voice
...
SessionOutcomeUnknown.__module__ = "agent_sessions.store"
PendingClaimLost.__module__ = "agent_sessions.store"

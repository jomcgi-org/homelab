...
from factory.execution.constants import INTERRUPTED_TERMINAL_REASONS, UNKNOWN_INVOCATION
...
def fence_factory_attempt_stop(
    ...
    if pending:
        from factory.execution.store import finish_unknown_pending_in_session

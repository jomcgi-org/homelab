...
import factory.execution.execution_api as api
...
def test_public_capacity_facade_is_lightweight_and_execution_exports_are_identical():
    ...
    script = """
import sys
import factory.execution.api as public
...
for module in (
    "factory.execution.execution_api", "factory.execution.mcp", "factory.execution.store",
    "factory.execution.transport", "goosecracker.api",
    "factory.orchestration.factory_attempt_stop", "factory.orchestration.factory_supervision",
):

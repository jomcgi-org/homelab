...
from factory.execution.transport import (
    EmberBrickGone,
...
async def _fresh_bound_guest_state(
    ...
    from factory.execution import router as agent_router
...
def _voice_ui_principal() -> tuple[str, str]:
    ...
    # The shared MCP middleware requires the operator group before dispatch.
    # Preserve principal facts in the companion ledger for attribution.
...
_ClaimStolen.__module__ = "agent_sessions.mcp"

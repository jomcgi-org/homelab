...
def get_queues():
    ...
    if _queues is None:
        ...
        from agent.api import DRAINER_WORKER_COUNT
...
def _prepare_drainer_workers_once(
    ...
    from agent.api import drainer_worker_intents, reserve_drainer_workers
...
def enqueue_drainer_workers(submitter, work_ids: list[str], *, queue=None) -> int:
    ...
    from factory.orchestration.drainer import drain_cycle

...
from factory.orchestration.turn_artifact import evaluate, evaluate_content
from factory.orchestration.unified_diff import parse_unified_diff
...
def _recover_response_lost(pin: dict, session_id: int) -> dict | None:
    ...
    from factory.execution.mcp import invoke_in_progress

...
from factory.orchestration import router as swarm_router
...
def dbos_registry():
    ...
    from factory.orchestration import node_workflows, steps  # noqa: F401 - register first
...
def test_every_node_workflow_step_is_in_the_hashed_member_list():
    ...
    from factory.orchestration import node_workflows, steps
    ...
    assert imported <= named, (
        f"factory.orchestration.steps names not hashed: {imported - named}"
    )

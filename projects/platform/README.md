...
| Component                                    | Purpose                                                                                                                                                                                                                |
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`linkerd/`](linkerd/)                       | mTLS and observability for all pod-to-pod traffic. Kubernetes `NetworkPolicy` doesn't work in meshed namespaces (Linkerd's port 4143 breaks it), so auth between services is handled at the mesh or app layer instead. |

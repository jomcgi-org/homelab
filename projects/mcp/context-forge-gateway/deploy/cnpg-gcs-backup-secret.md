# Context Forge CNPG GCS backup credential

This note records the existing out-of-band credential used by CloudNativePG:

- 1Password item path: `vaults/k8s-homelab/items/cnpg-gcs-backups-context-forge`
- Field name: `service-account-key.json`
- Service account: `cnpg-backup-context-forge@h0melab.iam.gserviceaccount.com`

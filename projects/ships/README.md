...
| **backend**  | REST + WebSocket API over SQLite with stationary-vessel deduplication (speed < 0.5 kn, distance < 100 m, and < 300 s elapsed); replays the NATS stream on startup to build its SQLite DB and subscribes for live updates |

...
The control plane's management API is authenticated and authorized (the TokenReview-gated `/invoke` pattern from the fc-invoke line). gVisor ([security/003](../../../projects/platform/ARCHITECTURE.md)) remains an alternative isolation runtime baseline.
...
| [networking/001](../../../projects/platform/ARCHITECTURE.md)             | Envoy is already the ingress; serving programs it via xDS                            |
| [security/003](../../../projects/platform/ARCHITECTURE.md)                     | Alternative isolation runtime baseline                                               |

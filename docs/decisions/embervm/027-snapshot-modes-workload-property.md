...
**Status:** Draft
**Created:** 2026-07-26
**Clarified by:** [ADR 028](028-demand-loaded-rootfs-oci-chunk-store.md), whose Account-scoped sharing applies only to immutable derived rootfs chunks; this ADR's mutable shared filesystem artifacts remain principal-scoped
...
This prohibition is specific to the mutable filesystem artifacts this ADR
defines. ADR 028's immutable, reconstructable rootfs chunks live in a separate
Account-owned keyspace and do not weaken this shared mode's principal boundary.

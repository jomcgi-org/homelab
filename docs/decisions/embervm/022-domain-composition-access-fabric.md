...
**Author:** jomcgi
**Status:** Draft
**Superseded in part by:** [024 - Identity Hierarchy and Guest Identity Assertion](024-identity-hierarchy-templates-and-registration.md) (the `domain` boundary in decision 2, which is now contained within exactly one principal, and the chargeback-at-domain row, which moves to Account) and [026 - Template Composition, GitOps Without Per-Workload CRs, and Registration](026-template-composition-gitops-registration.md) (the per-workload CR assumption behind open question 1; definitions move to a product manifest plus CP-datastore templates)
**Created:** 2026-07-25

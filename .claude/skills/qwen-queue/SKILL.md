...
| literal `<tool_call>` as the whole summary | same root cause as the row above, not an output-contract problem | see above; tightening the prompt does not fix it |

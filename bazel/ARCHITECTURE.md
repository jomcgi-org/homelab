...
| tooling/009 | Per-package visibility and tags classify monolith packages; lint out central `gazelle:exclude` | Accepted, partly executed; the #3932 ratchet blocks new central excludes and named-package globs while grandfathering existing entries; package visibility and tags remain open (#3930, #3931) | deleted |

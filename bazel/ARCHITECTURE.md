...
| tooling/009 | Per-package visibility and tags classify monolith packages; lint out central `gazelle:exclude` | Accepted, partly executed (#3931 and #3932 closed not planned 2026-09-14, #3930 tracks the rest); the #3932 ratchet blocks new central excludes and named-package globs while grandfathering existing entries; package visibility and tags remain open (#3930, #3931) | deleted |
